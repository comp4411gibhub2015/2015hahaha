...
void ImpressionistUI::cb_sizeSlides(Fl_Widget* o, void* v)
{
	...
	//printf("%d", ((ImpressionistUI*)(o->user_data()))->m_nSize);
}

//-----------------------------------------------------------
// Updates the Line brush Width to use from the value of the LineWidth
// slider
// Called by the UI when the LineWidth slider is moved
//-----------------------------------------------------------
...
//-----------------------------------------------------------
// Updates the Line brush Angle to use from the value of the LineAngle
// slider
// Called by the UI when the LineAngle slider is moved
//-----------------------------------------------------------
void ImpressionistUI::cb_LineAngleSlides(Fl_Widget* o, void* v)
{
	((ImpressionistUI*)(o->user_data()))->m_nLineAngle = int(((Fl_Slider *)o)->value());
	//printf("%d", ((ImpressionistUI*)(o->user_data()))->m_nLineAngle);
}
...
Fl_Menu_Item ImpressionistUI::menuitems[] = {
	...
	{ "&Display", 0, 0, 0, FL_SUBMENU},
		...
		{ "&Edge Image", FL_ALT + 'e', (Fl_Callback *)ImpressionistUI::cb_load_image },
		{ "&Another Image", FL_ALT + 'a', (Fl_Callback *)ImpressionistUI::cb_load_image },

		{ 0 },
	{ "&Options", 0, 0, 0, FL_SUBMENU },
		{ "&Faster", FL_ALT + 'f', (Fl_Callback *)ImpressionistUI::cb_load_image },
		{ "&Safer", FL_ALT + 's', (Fl_Callback *)ImpressionistUI::cb_load_image },
		{ 0 },
	{ "&Help",		0, 0, 0, FL_SUBMENU },
		{ "&About",	FL_ALT + 'a', (Fl_Callback *)ImpressionistUI::cb_about },
		{ 0 },
...
ImpressionistUI::ImpressionistUI() {
	...
	m_brushDialog = new Fl_Window(400, 325, "Brush Dialog");
		...
		// add line width of the brush slider to the dialog
